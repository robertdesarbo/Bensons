...
Route::get('download/{rule}', function ($rule) {
    ...
    } elseif ($rule == '2024_BESS_Softball_Legislative_Sponsor_Letter') {
    ...
    } elseif ($rule == '2024_BESS_Softball_Sponsor_Letter') {
